...
export const TariffsSidebar = ({
  ...
  const isButtonDisabled = (isCustomizable: boolean): boolean => {
    if (isCustomizable) {
      ...
      return (
        hasEmptyFields || hasEmptyCost || (nonChangesUnion && nonChangeFixed)
      );
    }
  };
      ...
      <div className="flex flex-col h-[calc(100vh-80px)] p-[30px]">
          ...
          {isEdit ? (
            <div className="mt-5">
              ...
              {tariffInfo?.type === "FIXED" ? (
                  ...
                  <div className="mb-3 flex gap-5">
                    <div className="w-1/2">
                      ...
                      <Input
                        ...
                        setTakeValue={(newValue) =>
                          handleCountResourcesChange(newValue, setCountMinutes)
                        }
                      />
                    </div>
                    <div className="w-1/2">
                ...
                <>
                  <div className="mb-3">
                    <span className="text-[18px] mb-1">Цена за гигабайт:</span>
                    <Input
                      placeholder="Введите цену"
                      value={String(costGigabyte)}
                      setTakeValue={(newValue) =>
            ...
            <>
              <div className="mt-5 pb-5 border-b-[1px] border-s-light-grey">
                <ul className="font-normal text-[18px] user-info-ul text-s-black">
                  <li>
                    <p className="font-normal w-[35%]">Статус:</p>
                  ...
                  <li>
                    <p className="text-s-black font-normal w-[35%]">
                      Описание:
                    </p>
                    <p className="font-light w-[65%]">
                  ...
                  {tariffInfo?.type === "CUSTOMIZABLE" && (
                    <>
                      <li>
                        <p className="font-normal w-[35%]">Цена за гигабайт:</p>
                        <p className="font-light w-[65%]">
                          {tariffInfo?.tariffResourceDto.costOneGigabyte}
                        </p>
                      </li>
                      <li>
                        <p className="font-normal w-[35%]">Цена за минуту:</p>
                        <p className="font-light w-[65%]">
              ...
              {tariffInfo?.type === "FIXED" ? (
                <div className="grid grid-cols-3 mt-5 gap-x-[2.3rem] gap-y-2">
                  <div className="col-start-2 text-[18px]">Количество:</div>
                  <div className="text-[18px]">Цена единицы:</div>
                  <div className="text-[18px]">Гигабайты:</div>
                  ...
                  <div className="text-[18px]">Минуты:</div>
                  <div className="font-light text-[18px]">
                    {tariffInfo?.tariffResourceDto.countMinutes}
                  </div>
                  <div className="font-light text-[18px]">
                  ...
                  <div className="text-[18px]">СМС:</div>
                  <div className="font-light text-[18px]">
                    {tariffInfo?.tariffResourceDto.countSms}
                  </div>
                  <div className="font-light text-[18px]">
                  ...
                  <div className="mb-2">
                    ...
                    <div className="px-4">
                      <TariffBar
                        ...
                        max={
                          tariffInfo?.tariffResourceDto?.stepsGigabytes[
                            tariffInfo?.tariffResourceDto?.stepsGigabytes
                              ?.length - 1
                          ]
                        }
                  ...
                  <div className="mb-2">
                    ...
                    <div className="px-4">
                      <TariffBar
                        ...
                        max={
                          tariffInfo?.tariffResourceDto?.stepsMinutes[
                            tariffInfo?.tariffResourceDto?.stepsMinutes
                              ?.length - 1
                          ]
                        }
                  ...
                  <div className="mb-2">
                    ...
                    <div className="px-4">
                      <TariffBar
                        ...
                        max={
                          tariffInfo?.tariffResourceDto?.stepsSms[
                            tariffInfo?.tariffResourceDto?.stepsSms?.length - 1
                          ]
                        }
                      />
                    </div>
        ...
        {tariffInfo?.type === "FIXED" && (
          <div className="pt-5 border-t-[1px] border-s-light-grey">
            <p className="text-[26px] font-light flex items-center">
              Цена тарифа: {tariffInfo?.cost} ₽
              {isPriceManuallySet && (
                <span
                ...
                >
                  ...
                  {showTooltip && (
                    <div
                      className="absolute top-[-35px] left-[14px] bg-black text-white text-sm p-2 rounded shadow-lg z-10"
