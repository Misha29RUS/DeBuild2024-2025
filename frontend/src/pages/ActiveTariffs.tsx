...
export const ActiveTariffs = () => {
  ...
  const [statusTariff, setStatusTariff] = useState<"ACTIVE" | "HIDDEN">(
    "ACTIVE",
  );
  ...
  const { data: tariffsData }: any = useGetTariffsQuery({
    status: statusTariff,
    ...
    <div className="grow px-[90px] py-10 overflow-y-auto">
      <div className="flex items-center mb-2.5">
        <div className="flex items-center mr-auto">
          <h2 className="text-[34px] text-s-black mr-3">Тарифы</h2>
          {/*<Counter*/}
      ...
      <div className="mb-10 flex items-center">
        ...
        {isAdmin && (
          <Button
            onClick={() => setIsSidebarNewTariff(true)}
            text="Новый тариф"
            type="red"
            iconLeft={<AddSvg />}
          />
